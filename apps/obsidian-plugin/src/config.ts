import { DEFAULT_USER_AUTH_CONFIG_PATH } from "@obsidian-image-clipper/shared";

export const APP_TITLE = "Obsidian Image Clipper  0.1.0";
export const DEFAULT_AUTH_CONFIG_PATH = DEFAULT_USER_AUTH_CONFIG_PATH;
...
export const DEFAULT_SETTINGS: ISettings = {
  ...
  authConfigPath: DEFAULT_AUTH_CONFIG_PATH,
